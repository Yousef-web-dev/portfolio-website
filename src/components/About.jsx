...
export default function About() {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="px-[5%] py-[100px] bg-surface"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-10 md:gap-16 items-center">
        ...
        <div className="reveal-right">
          ...
          <div className="flex flex-wrap gap-2.5 mt-6">
            <span className="px-4 py-1.5 bg-accent/10 border border-accent/25 rounded-full text-[0.8rem] text-accent font-semibold cursor-default transition-transform hover:scale-[1.06] hover:bg-accent/20">
              🎓 Information Systems
            </span>
            <span className="px-4 py-1.5 bg-accent/10 border border-accent/25 rounded-full text-[0.8rem] text-accent font-semibold cursor-default transition-transform hover:scale-[1.06] hover:bg-accent/20">
              📍 Haram, Giza
      ...
      <div
        className="stats-row reveal grid grid-cols-1 sm:grid-cols-3 gap-5 mt-10"
        ref={statsRef}
      >
        <div className="bg-card border border-border rounded-xl p-5 text-center transition-all hover:-translate-y-1 hover:border-accent">
          <div
            className="stat-num font-mono text-[1.8rem] font-bold bg-grad bg-clip-text text-transparent"
            data-target="3"
          >
            0
          </div>
